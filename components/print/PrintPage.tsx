    ...
    return (
        <div className="h-full flex flex-col lg:flex-row gap-6 animate-in px-4 lg:px-0 overflow-hidden">
            ...
            <div className="hidden lg:grid grid-cols-12 gap-6 w-full h-full max-h-[calc(100vh-140px)]">
                ...
                {/* LEFT — Upload */}
                <div className="col-span-4 bg-[#111117]/60 border border-white/[0.06] rounded-3xl p-6 backdrop-blur-xl overflow-y-auto no-scrollbar">
                    <UploadCard
                        files={files}
                ...
                {/* CENTER — Settings */}
                <div className="col-span-4 bg-[#111117]/60 border border-white/[0.06] rounded-3xl p-5 backdrop-blur-xl overflow-y-auto overflow-x-hidden no-scrollbar">
                    <SettingsCard
                        options={options}
                        onChange={setOptions}
