...
export const SummaryCard: React.FC<SummaryCardProps> = ({
 ...
 <p className="text-sm text-[#666] mt-0.5">Review your order before checkout</p>
 </div>
 ...
 {/* Divider */}
 <div className="border-t border-[#333]/[0.06] my-1" />
 ...
 <span className={cn('truncate', line.amount < 0 ? 'text-emerald-400' : 'text-[#666]')}>
 {line.label}
 </span>
 {line.detail && (
 <span className="text-[10px] text-[#666] shrink-0">{line.detail}</span>
 )}
 </div>
 ...
 <p className="text-[10px] font-bold text-[#666] uppercase tracking-widest mb-2">Estimated Total</p>
 ...
 hasFiles && !disabled
 ? 'bg-red-600 text-white hover:shadow-[0_0_30px_rgba(255,255,255,0.12)] cursor-pointer'
