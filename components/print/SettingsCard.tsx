...
export const SettingsCard: React.FC<SettingsCardProps> = ({
 ...
 <div>
 <h2 className="text-lg font-bold text-foreground tracking-tight">Print Settings</h2>
 <p className="text-xs text-foreground-muted mt-0.5">Customize your print options</p>
 </div>
 <button
 onClick={reset}
 ...
 {/* COLOR */}
 <section>
 <label className="text-[10px] font-bold text-foreground-muted uppercase tracking-widest mb-3 block">Color</label>
 ...
 {/* SIDES */}
 <section>
 <label className="text-[10px] font-bold text-foreground-muted uppercase tracking-widest mb-3 block">Sides</label>
 <div className="flex flex-wrap gap-2">
 <OptionButton
 label="Single"
 ...
 {/* PAPER SIZE */}
 <section>
 <label className="text-[10px] font-bold text-foreground-muted uppercase tracking-widest mb-3 block">Paper Size</label>
 ...
 className="size-10 bg-primary text-foreground flex items-center justify-center hover:bg-gray-200 transition-colors"
 >
 <Plus size={16} />
 </motion.button>
 </div>
 ...
 <section>
 <label className="text-[10px] font-bold text-foreground-muted uppercase tracking-widest mb-3 block">Pages to Print</label>
 <input
 type="text"
 ...
 {/* BINDING */}
 <section>
 <label className="text-[10px] font-bold text-foreground-muted uppercase tracking-widest mb-3 block">Binding</label>
 ...
 <h3 className="text-[10px] font-bold text-foreground-muted uppercase tracking-widest mb-3">Cost Breakdown</h3>
 <div className="space-y-1.5">
 {breakdown.lines.map((line, i) => (
 <div key={i} className="flex justify-between items-baseline text-sm">
 <div className="flex items-baseline gap-1.5 min-w-0">
 <span className={cn('truncate', line.amount < 0 ? 'text-emerald-400' : 'text-foreground-muted')}>{line.label}</span>
 {line.detail && <span className="text-[10px] text-foreground-muted shrink-0">{line.detail}</span>}
 </div>
