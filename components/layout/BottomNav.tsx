            ...
            <nav className="flex items-center justify-around p-2">
                ...
                {user && (
                    <button
                        ...
                        className="flex flex-col items-center gap-1 p-2 text-foreground-muted hover:text-foreground relative group transition-all duration-200 active:scale-95"
                    >
                        <div className="relative">
                            <ShoppingBag size={22} strokeWidth={2} />
                            {totalItems > 0 && (
                                <span className="absolute -top-1.5 -right-1.5 flex items-center justify-center min-w-[16px] h-4 px-1 bg-primary text-foreground text-[9px] font-bold rounded-full border border-background">
                                    {totalItems}
                                </span>
                            )}
                        </div>
