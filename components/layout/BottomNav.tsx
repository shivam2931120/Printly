...
export const BottomNav: React.FC<BottomNavProps> = ({ user }) => {
 ...
 return (
 <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#050505] border-t border-[#333] lg:hidden pb-safe">
 ...
 isActive ? "text-red-500" : "text-[#666] hover:text-white"
 )}
 >
 ...
 className="flex flex-col items-center gap-1 p-2 text-[#666] hover:text-white relative group transition-all duration-200 active:scale-95"
 >
 <div className="relative">
 <ShoppingBag size={22} strokeWidth={2} />
 {totalItems > 0 && (
 <span className="absolute -top-1.5 -right-1.5 flex items-center justify-center min-w-[16px] h-4 px-1 bg-red-600 text-white text-[9px] font-bold border border-[#050505]">
 {totalItems}
 </span>
 )}
 </div>
