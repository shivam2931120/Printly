        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-[#111] border border-[#333]/[0.10] text-sm font-medium text-white hover:bg-[#0A0A0A]/[0.10] transition-colors"
