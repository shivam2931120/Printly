...
export const ProfilePage: React.FC = () => {
 ...
 className="bg-red-600 text-white hover:bg-[#0A0A0A]/90 font-black px-8 h-12 transition-all"
 >
 ...
 {order.otp && (
 <span className="px-2 py-0.5 bg-[#111]0/20 text-blue-400 text-[10px] font-bold rounded border border-blue-500/30 tracking-wider">
 OTP: {order.otp}
 </span>
 )}
 </div>
 ...
 <div className="absolute -bottom-2 -right-2 size-8 bg-red-600 text-white flex items-center justify-center border-4 border-[#050505]">
 ...
 <p className="text-[#666] text-sm font-medium opacity-60">{user.email}</p>
 </div>

 <div className="flex gap-2">
 {user.isAdmin && (
 <span className="px-4 py-1.5 bg-red-600 text-white text-[10px] font-black uppercase tracking-[0.15em]">Administrator</span>
 )}
 {user.isDeveloper && (
 ...
 className="w-full flex items-center justify-between p-5 bg-[#111]0/10 border border-red-600/20 hover:bg-[#111]0/15 transition-all group"
 >
 <div className="flex items-center gap-4">
 <div className="size-12 bg-[#111]0/20 flex items-center justify-center text-blue-400 group-hover:scale-110 transition-transform">
 ...
 <p className="text-[10px] text-[#666] font-bold opacity-40 uppercase tracking-widest mt-1">Track history</p>
 </div>
 </button>
 ...
 <p className="text-[10px] text-[#666] font-bold opacity-40 uppercase tracking-widest mt-1">Get assistance</p>
 </div>
 </button>
 </div>
 ...
 >
 <div className="flex items-center gap-4">
 <div className="size-10 bg-red-900/20/10 flex items-center justify-center text-red-500 group-hover:scale-110 transition-transform">
 <LogOut size={20} />
 </div>
