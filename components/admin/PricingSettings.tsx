...
export const PricingSettings: React.FC<PricingSettingsProps> = ({ pricing, onUpdate }) => {
 ...
 <p className="text-foreground-muted mt-1">Configure print pricing and discounts</p>
 </div>
 <div className="flex gap-2">
 <button
 onClick={handleReset}
 className="px-4 py-2 text-foreground-muted hover:bg-background-subtle transition-colors"
 >
 Reset to Default
 </button>
 <button
 ...
 className="w-full px-4 py-2.5 bg-background-card border border-border rounded-2xl shadow-2xl text-foreground focus:ring-2 focus:ring-red-600"
 />
 </div>
 <div>
 <label className="block text-sm font-medium text-foreground-muted mb-2">
 ...
 <div className="bg-background-card border border-border rounded-2xl shadow-2xl p-6">
 <h3 className="text-lg font-bold text-foreground mb-4 flex items-center gap-2">
 <Icon name="crop_portrait" className="text-primary" />
 Paper Size Multipliers
 </h3>
 ...
 <div key={size}>
 <label className="block text-sm font-medium text-foreground-muted mb-2 uppercase">
 {size} (×)
 </label>
 <input
 type="number"
